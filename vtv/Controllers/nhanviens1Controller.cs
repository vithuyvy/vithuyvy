...
namespace vtv.Controllers
{
    public class nhanviens1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Tennhanvien,Sdt,Diachi")] nhanvien nhanvien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Tennhanvien,Sdt,Diachi")] nhanvien nhanvien)
        {
            if (ModelState.IsValid)
            {
